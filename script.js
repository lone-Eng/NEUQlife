...
function showPopup(title,resultText,changes,hiddenInfo,callback){
  ...
  overlay.innerHTML='<div class="popup-box"><div class="popup-title">'+title+'</div>'+(rt?'<div class="popup-result">'+rt+'</div>':'')+chgHtml+hh+'<button class="popup-btn" id="'+popId+'">确定</button></div>';
